        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-b-lg shadow-lg p-8">
                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
                    ...
                    <button
                        type="submit"
                        class="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
                    >
                        Zaloguj się
                    </button>
                </form>
